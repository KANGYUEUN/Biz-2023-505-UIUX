document.addEventListener("DOMContentLoaded", () => {
  ...
  // const image_view = documant.querySelector("div.image_view");

  // image_view box 를 한번 select 하고
  // image_view box 가 포함하는 img tag 를 또한번 select 하기
